...
На linux существуют 2 чаще используемых дебаггера это [GDB](https://sourceware.org/gdb/current/onlinedocs/)/[LLDB](https://lldb.llvm.org/use/tutorial.html) и [valgrind](https://valgrind.org/docs/manual/manual.html)
